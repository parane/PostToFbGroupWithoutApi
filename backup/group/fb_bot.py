...
class FbBot():
    ...
    def automate_status(self, URL):
        ...
        login.send_keys("தமிழ் சொந்தகளுக்கு  வணக்கம் !!!  Tamil Gif I-phone App for chat!!! try this app friends!!\nios : https://itunes.apple.com/us/app/tamil-gif/id1211824683?mt=8 \nmore Tamil apps:https://itunes.apple.com/us/developer/tharshan-balasubramaniam/id1092895499 ")
